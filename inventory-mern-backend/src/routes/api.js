...
router.delete("/DeleteBrand/:id", AuthVerifyMiddleware, BrandsController.DeleteBrand);
...
router.delete("/DeleteCategories/:id", AuthVerifyMiddleware, CategoriesController.DeleteCategories);
