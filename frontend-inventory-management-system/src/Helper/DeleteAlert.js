    ...
    <div>
      <div className='w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-[#374151] '>
        <div className='text-center p-5 flex-auto justify-center'>
          ...
          <h2 className='text-xl text-white font-bold py-4 '>Are you sure?</h2>
          <p className='text-sm text-white md:px-8'>{Text}</p>
        </div>
...
export const DeleteItems = (id, text, deleteRequestAPI, refreshAPI) => {
  toast(
    <DeleteAlert
      Id={id}
      Text={text}
      deleteRequestAPI={deleteRequestAPI}
      nextReturnRequestAPI={refreshAPI}
    />,
    {
      position: "top-center",
      autoClose: false,
...
const confirmDeleteAds = (Id, deleteRequestAPI, refreshAPI) => {
