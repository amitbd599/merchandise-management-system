...
const SupplierUpdate = () => {
  ...
  useEffect(() => {
    SupplierDetailsByID(params?.id);
  }, []);
  const saveChange = async () => {
    let Email = emailRef.value;
    let SupplierName = nameRef.value;
    ...
    if (IsEmpty(SupplierName)) {
      ...
      await SupplierUpdateRequestAPI(
        { Email, SupplierName, Phone, Address, Image },
        params?.id
      ).then((result) => {
        if (result) {
  ...
  useEffect(() => {
    setImg(singleSupplierData?.Image);
  }, [singleSupplierData]);
      ...
      <div className='grid min-h-[calc(100vh-50px)] place-items-center bg-slate-100 px-6'>
        <div className='w-11/12 p-12 bg-white drop-shadow-2xl rounded-lg sm:w-8/12 md:w-1/2 lg:w-full'>
          <h1 className='text-xl font-semibold'>
            <span className='font-medium'>Edit Supplier</span>{" "}
          ...
          <div className='mt-6'>
            <div className='flex gap-6'>
              <div className='w-full'>
                ...
                <input
                  Value={singleSupplierData?.SupplierName}
              ...
              <div className='w-full'>
                ...
                <input
                  Value={singleSupplierData?.Phone}
            ...
            <div className='flex gap-6 mt-2'>
              <div className='w-full'>
                ...
                <input
                  Value={singleSupplierData?.Email}
              ...
              <div className='w-full'>
                ...
                <input
                  Value={singleSupplierData?.Address}
