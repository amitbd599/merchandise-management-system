...
import { RemoveReturnItem, SetReturnItemList } from "../../redux/state-slice/return-slice";
...
const ReturnCreateUpdate = () => {
    ...
    const [note, setNote] = useState(`Return create successful ${formattedDate}`);
    ...
    const totalValuebyselectProduct = ReturnItemList.reduce((acc, product) => acc + product.Total, 0);
